...
libs.string_getHost = function(url, isReal = false) {
...
libs.string_base64_encode = (input) => {
...
libs.string_base64_decode = (input) => {
  let keyStr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
  var output = "";
        var chr1, chr2, chr3 = "";
        var enc1, enc2, enc3, enc4 = "";
