...
source.getResource = function (movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                urlSearch = "http://them4ufree.info/tag/" + slugify(movieInfo.title, { lower: true, replacement: '-', remove: /[*+~.()'"!:@]/g });
            ...
            case 1:
                ...
                parseSearch(".top-item").each(function (keySearch, itemSearch) {
                    var title = parseSearch(itemSearch).find("cite").text();
                    var year = title.match(/\( *([0-9]+)/i);
                    year = year ? year[1] : 0;
                    title = title.replace(/\( *[0-9]+ *\)/i, "").trim();
                    var href = parseSearch(itemSearch).attr("href");
                ...
                if (!(link != "")) return [3, 8];
                ajaxUrl_1 = "http://them4ufree.info/ajax";
                linkTv = '';
            ...
            case 2:
                ...
                tokens_1 = [];
                token_1 = htmlDetail.match(/_token *: *\'([^\']+)/i);
                token_1 = token_1 ? token_1[1] : '';
                headers_1 = {
                    "content-type": "application/x-www-form-urlencoded; charset=UTF-8"
                };
                if (!(movieInfo.type == "tv")) return [3, 5];
                ajaxTv = "http://them4ufree.info/ajaxtv";
                idTv_1 = "";
                console.log(parseDetail_1(".episode").length, "--------- them4ufree SEARCH EPISODE TV ---------");
            ...
            case 3:
                ...
                console.log(parseTv_1(".singlemv").length, "--------- them4ufree TOKEN TV ---------");
            ...
            case 4: return [3, 6];
            case 5:
                console.log(parseDetail_1(".singlemv").length, "--------- them4ufree TOKEN MOVIE ---------");
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                console.log(htmlEmbed, headers_1, body, ajaxUrl_1, "--------- THEM4UFREE htmlEmbed parse ---------");
