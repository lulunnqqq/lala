...
var _this = this;
hosts["streamtape"] = function (url, movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var urlEmbed, htmlEmbed, parseEmbed, urlDirect, resultHead, file, fileSize;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                urlEmbed = url.replace('/v/', '/e/');
                return [4, libs.request_get(urlEmbed)];
            case 1:
                htmlEmbed = _a.sent();
                parseEmbed = cheerio.load(htmlEmbed);
                console.log(htmlEmbed, '----------------- STREAMTAPE HTML ------------');
                urlDirect = parseEmbed('#videolink').text();
                ...
                return [4, libs.request_head(urlDirect, {}, false)];
            case 2:
                resultHead = _a.sent();
                file = resultHead.url;
