...
var _this = this;
hosts["bmoviesfree"] = function (url, movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var id, urlApi, body, headers, parse, sources, arrMap;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(url, "--------- MOVCLOUD URL -----------");
                id = url.match(/v\/([A-z0-9-+]+)/i);
                id = id ? id[1] : "";
                urlApi = "https://bmoviesfree.io/api/source/" + id;
                body = "r=&d=bmoviesfree.io";
                headers = {
