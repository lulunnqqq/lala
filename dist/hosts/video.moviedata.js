...
var _this = this;
hosts["video.moviedata"] = function (url, movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var urlEmbed, result, arrMap;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                urlEmbed = url.replace("https://video.moviedata.xyz/embed/player.html", "https://video.moviedata.xyz/api");
            ...
            case 1:
                ...
                arrMap = result.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                    var embed, fileSize, host, e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 3, , 4]);
