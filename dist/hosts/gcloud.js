...
var _this = this;
hosts["gcloud"] = function (url, movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = id ? id[1] : "";
                urlAPI = "https://gcloud.live/api/source/" + id;
                headers = {
                    "content-type": "application/x-www-form-urlencoded; charset=UTF-8"
                };
                body = "r=&d=gcloud.live";
